...
USE POLSYS
COMPLEX (KIND=R8), allocatable(:,:) :: myROOTS

contains

subroutine solve(abc)
!
...
OPEN (UNIT=3,FILE='INPUT1.DAT',ACTION='READ',POSITION='REWIND',   &
...
DO
  ...
  IF (NEW_PROBLEM) THEN
    ...
    DO I=1,N
      ...
      DO J=1,NUM_TERMS(I)
        write(*, *) (I,J,COEF(I,J),K,DEG(I,J,K), K=1,N)
